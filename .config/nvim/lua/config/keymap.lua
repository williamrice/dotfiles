...
map("n", "<C-A-h>", "<cmd>vertical resize -15<cr>", { desc = "Decrease window width" })
map("n", "<C-A-j>", "<cmd>resize +15<cr>", { desc = "Increase window height" })
map("n", "<C-A-k>", "<cmd>resize -15<cr>", { desc = "Decrease window height" })
map("n", "<C-A-l>", "<cmd>vertical resize +15<cr>", { desc = "Increase window width" })
...
end, { desc = "Reset debugger UI layout" })
